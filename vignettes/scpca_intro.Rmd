...
The hyperparemeters of the cPCA and scPCA algorithms provided in this package
are selected through a clustering-based hyperparemeter tuning framework
(detailed in [@boileau2020]). If the discovery of non-generalizable patterns in
the data becomes a concern, a cross-validated approach to this tuning framework
is made available.
