...
#' Paralellized with the \code{future.apply} package.
#'
...
#'
future_contrastiveCov <- function(target, background, contrasts, center, scale) {
  ...
  c_contrasts <- future_lapply(contrasts, function(x) {
